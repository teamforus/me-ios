...
extension MInfoVoucherTableViewCell {
  ...
  func setupConstraints(){
    ...
    NSLayoutConstraint.activate([
      ...
      emailButton.widthAnchor.constraint(equalToConstant: 180),
      ...
      emailButton.widthAnchor.constraint(equalToConstant: 156),
    ])
    ...
    NSLayoutConstraint.activate([
      ...
      voucherInfoButton.widthAnchor.constraint(equalToConstant: 156),
    ])
  }
