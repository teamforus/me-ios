...
class CollOKCell: UICollectionViewCell {
    ...
    func addSuviews() {
        self.contentView.addSubview(okLabel)
        self.contentView.addSubview(line)
    }
    
    func setupConstraints() {
        NSLayoutConstraint.activate([
            line.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 0),
            line.rightAnchor.constraint(equalTo: self.contentView.rightAnchor, constant: 0),
            line.leftAnchor.constraint(equalTo: self.contentView.leftAnchor, constant: 0),
            line.heightAnchor.constraint(equalToConstant: 0.7)
        ])
        
        NSLayoutConstraint.activate([
            okLabel.centerYAnchor.constraint(equalTo: self.contentView.centerYAnchor),
            okLabel.centerXAnchor.constraint(equalTo: self.contentView.centerXAnchor),
            okLabel.heightAnchor.constraint(equalToConstant: 44),
            okLabel.widthAnchor.constraint(equalToConstant: 44)
        ])
    }
}
