...
final class SheetPresentationController: UIPresentationController {
  ...
  override var frameOfPresentedViewInContainerView: CGRect {
    ...
    guard let containerView = containerView, var presentedView = presentedView else {
      return super.frameOfPresentedViewInContainerView
    }
      
      if let navController = presentedViewController as? UINavigationController, let topViewController = navController.viewControllers.first {
          presentedView = topViewController.view
      }
    ...
    let targetOrigin = CGPoint(x: 0, y: containerView.frame.maxY - targetSize.height)
  ...
  private let handleView: UIView = {
    ...
    view.frame.size = CGSize(width: 24, height: 4)
    return view
  }()
...
//
  ...
  private func layoutAccessoryViews() {
    ...
    handleView.center.x = presentedView.center.x - 16
